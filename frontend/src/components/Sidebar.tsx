...
export default function Sidebar() {
    return (
        <aside className="sidebar">
            ...
            <nav>
                <ul>
                    <NavLink to="/home/dashboard" className={({isActive}) => isActive ? 'nav-link active' : 'nav-link'}>
                    <li>
                        <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e3e3e3"><path d="M240-200h120v-240h240v240h120v-360L480-740 240-560v360Zm-80 80v-480l320-240 320 240v480H520v-240h-80v240H160Zm320-350Z"/></svg>
                        <div className="text">Dashboard</div>
                    </li>
                    </NavLink>
                    <NavLink to="/home/transactions" className={({isActive}) => isActive ? 'nav-link active' : 'nav-link'}>
                    ...
                    <NavLink to="/home/categories" className={({isActive}) => isActive ? 'nav-link active' : 'nav-link'}>
                    ...
                    <NavLink to="/home/reports" className={({isActive}) => isActive ? 'nav-link active' : 'nav-link'}>
